...
> Answer: Using cleint side routing has the benefit of your entire page bieing held in one page and that means that your page won't need to reload to change paths. This allows for a seemingly faster interface which is better for users. 
